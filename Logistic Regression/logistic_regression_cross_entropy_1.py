...
Original file is located at
    https://colab.research.google.com/drive/18mdAdXnAysb9nRoAP8eac-fLYOnhxaew
...
Table of Contents
* Will review how to make a prediction in several different ways by using PyTorch.
